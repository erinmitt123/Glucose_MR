...
{
    public class MnistFrame : MonoBehaviour
    {
        public TextAsset mnistModel;
        public TextAsset tvGltfAsset;
        public TextAsset tvGltfAsset2;
        ...
        private void CreateRenderer()
        {
            ...
            gltfTensor4 = provider.CreateTensor<Gltf>(tvGltfAsset2.bytes);
            ...
            renderGltfOp3.SetOperand("view locked", poseMat3);
             ...
             //textureIdPlaceholder = rendererPipeline.CreateTensorReference<ushort, Scalar>(1, new TensorShape(new[] { 1 }));
            
                      
             // var renderTextOp4 = rendererPipeline.CreateOperator<RenderTextOperator>(
             //     new RenderTextOperatorConfiguration(SecureMRFontTypeface.SansSerif, "en-US", 1080, 1080));
             // renderTextOp4.SetOperand("text", text3);
             // renderTextOp4.SetOperand("start", startPosition);
             // renderTextOp4.SetOperand("colors", colors);
             // renderTextOp4.SetOperand("texture ID", textureIdPlaceholder);
             // renderTextOp4.SetOperand("font size", fontSize);
             // renderTextOp4.SetOperand("gltf", gltfPlaceholder4);
            
           // var renderGltfOp5 = rendererPipeline.CreateOperator<SwitchGltfRenderStatusOperator>();
           //  renderGltfOp5.SetOperand("gltf", gltfPlaceholder4);
           //  renderGltfOp5.SetOperand("world pose", poseMat3);
           // renderGltfOp5.SetOperand("view locked", poseMat3);
